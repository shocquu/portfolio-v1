...
<header>
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="active-page"><a href="contact.php">Contact</a></li>
  ...
  <div class="content">
    ...
    <div class="content-right">
      <form class="contact-form" action="contact.php" method="post">
        ...
        <textarea name="message" rows="8" cols="80" placeholder="What's matter?" required></textarea>
        <button name="message-btn" class="message-btn">Send message</button>
      </form>
    </div>
  </div>
</main>
